...
t = dt*(0:N-1);
figure('Name', 'Sygnał');
set(figure(2),'units','points','position',[0,400,720,350]);
plot(t, x,'b');
...
set(figure(3),'units','points','position',[720,400,720,350]);
...
set(figure(4),'units','points','position',[0,30,720,306]);
hold on;
plot(f, Halog,'b');
plot(f, Hdlog,'r');
...
set(figure(5),'units','points','position',[720,30,720,306]);
