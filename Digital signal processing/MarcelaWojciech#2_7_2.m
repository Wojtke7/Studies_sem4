...
% Długość okna  L=512 została wybrana, aby uzyskać odpowiedni kompromis między złożonością obliczeniową
% a efektywnością filtracji. Dłuższe okna prowadzą do lepszych charakterystyk częstotliwościowych filtra 
% (ostrzejsze przejście i lepsze tłumienie pasma zaporowego), ale kosztem większej złożoności obliczeniowej.
L1 = 512;
L2 = 512;
L3 = 512;
...
% Projektujemy i stosujemy filtr Butterwortha 4. rzędu
% do wyodrębnienia interesującej nas usługi z szerokopasmowego sygnału.
